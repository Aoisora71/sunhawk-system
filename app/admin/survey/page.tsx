      ...
      <div className="flex">
        ...
        <main className="flex-1 p-3 sm:p-4 md:p-8 w-full">
          <div className="max-w-4xl mx-auto space-y-6 sm:space-y-8">
            {/* Page Header */}
            <div>
              <h1 className="text-2xl sm:text-3xl md:text-4xl font-medium text-foreground mb-2">アンケート参加</h1>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <Card className="border-2 border-primary/20 bg-gradient-to-br from-primary/5 to-transparent">
                ...
                <CardContent className="space-y-4">
                  <Link href="/admin/survey/employee-survey" className="block">
                    <Button
              ...
              <Card className="border-2 border-primary/20 bg-gradient-to-br from-primary/5 to-transparent">
                ...
                <CardContent className="space-y-4">
                  <Link href="/admin/survey/growth-survey" className="block">
                    <Button
                      className="w-full bg-primary hover:bg-primary/90 text-primary-foreground text-base sm:text-lg py-6"
            ...
            <Card className="bg-muted/30">
              ...
              <CardContent className="space-y-2 text-sm">
                ...
                <p className="text-muted-foreground">• 管理者として参加した回答も、一般従業員と同様に集計されます</p>
              </CardContent>
            </Card>
          </div>
        </main>
